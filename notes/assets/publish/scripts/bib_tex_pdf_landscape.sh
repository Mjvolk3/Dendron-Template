...
# notes/assets/publish/scripts/bib_tex_pdf_landscape.sh
# [[notes.assets.publish.scripts.bib_tex_pdf_landscape]]
# https://github.com/Mjvolk3/Dendron-Template/tree/main/notes/assets/publish/scripts/bib_tex_pdf_landscape.sh
