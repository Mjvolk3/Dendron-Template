...
# PROJECT-SPECIFIC: Change "Dendron-Template" to your package name
PYTHON_PKG_REL_PATH = os.getenv("PYTHON_PKG_REL_PATH", "Dendron-Template")
...
def handle_file(file_path, new_file_path):
    ...
    if file_extension == ".py" and file_path.startswith(osp.join(get_git_root(), PYTHON_PKG_REL_PATH)):
